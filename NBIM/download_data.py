...
if os.path.exists(equity_csv):
    ...
    print("🔄 Downloading weekly equities (1y)...")
    df_all = pd.DataFrame()
...
if os.path.exists(bonds_csv):
    ...
    print(f"✅ Fixed income data saved to: {bonds_csv}")
