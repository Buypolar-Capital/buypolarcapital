...
# Font for Goldman Sachs styling
font_add_google("Montserrat", "gs_font")
showtext_auto()

# SETTINGS
tickerA <- "AZN"     # US ADR
tickerB <- "AZN.L"   # London listing
initial_capital <- 1e7
threshold <- 1
...
# Load and prep data (from 2000 onward)
...
pdf("plots/dual_arbitrage_facet_AZN_AZNL.pdf", width = 11, height = 8.5)
